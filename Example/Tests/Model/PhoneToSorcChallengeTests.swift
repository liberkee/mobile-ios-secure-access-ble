...
class PhoneToSorcChallengeTests: QuickSpec {
    override func spec() {
        ...
        let challenge: [UInt8] = [0x01, 0x00, 0x00, 0x00,
                                  0x00, 0x00, 0x00, 0x00,
                                  0x00, 0x00, 0x00, 0x00,
                                  0x00, 0x00, 0x00, 0x02]
        ...
        describe("init") {
            ...
            it("creates data sequence") {
                let expectedRawDataHexString = "39333736333938322d346363302d343937342d623133382d32333066646163363738366332616535386533312d653862302d343236302d616661332d65356638626632643565303762396130663531372d303936632d346136612d623838642d62633564376434626237336401000000000000000000000000000002"
